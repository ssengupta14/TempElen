...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/revolution.css"/>" media="screen" /> <!-- Slider Revolution -->	
<link rel="stylesheet" href="<c:url value="/resources/css/mystyle.css"/>" media="screen" type="text/css" />
	...
	<header class="header2">
		<div class="container">
			<div class="top-bar">
				...
				<span><i class="fa fa-mobile">&nbsp;&nbsp;24/7 Support: 123-456-7890</i></span>
			</div>
		</div>
	<nav>	
		<div class="container">
...
<script src="<%=request.getContextPath() %>/resources/js/myindex.js"></script><!-- Jquery -->
